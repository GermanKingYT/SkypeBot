...
#Region " Dark Colors"
    ...
    Private _BaseColor As Color = Color.FromArgb(24, 24, 24)
    Private _BorderColor As Color = Color.FromArgb(24, 24, 24)
...
#Region " Light Colors"
    ...
    Public TextLight As Color = Color.FromArgb(24, 24, 24)
...
#End Region
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        With G
            ...
            .FillRectangle(New SolidBrush(Color.FromArgb(222, 200, 222)), 16, 16, 4, 18)
...
#Region " Colors"
    ...
    Private _BaseColor As Color = Color.FromArgb(40, 40, 40)
    Private _TextColor As Color = Color.FromArgb(211, 211, 211)
...
#End Region
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        With G
            ...
            '-- X
            .DrawString("X", Font, New SolidBrush(TextColor), New Rectangle(0, 0, Width, Height), CenterSF)
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        With G
            ...
            ElseIf FindForm.WindowState = FormWindowState.Normal Then
                .DrawString("-", Font, New SolidBrush(TextColor), New Rectangle(1, 1, Width, Height), CenterSF)
            End If
...
#End Region
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        With G
            ...
            '-- Minimize
            .DrawString("_", Font, New SolidBrush(TextColor), New Rectangle(2, 1, Width, Height), CenterSF)
...
#End Region
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        With G
            ...
            '-- if ShowText
            If ShowText Then
                .DrawString(Text, Font, New SolidBrush(Color.FromArgb(211, 211, 211)), New Rectangle(16, 16, W, H), NearSF)
            End If
        End With
...
#Region " Colors"
    ...
    Private BaseColorRed As Color = Color.LightSkyBlue
    Private BGColor As Color = Color.FromArgb(30, 30, 30)
    Private ToggleColor As Color = Color.FromArgb(45, 47, 49)
    Private TextColor As Color = Color.FromArgb(90, 211, 211)
            ...
            Select Case O
                Case _Options.Style1   '-- Style 1
                    ...
                    If Checked Then
                        ...
                        '-- Text
                        .DrawString("ON", Font, New SolidBrush(BaseColorRed), New Rectangle(8, 7, W, H), NearSF)
                    End If
                Case _Options.Style2   '-- Style 2
                    ...
                    '-- Text
                    .DrawString("r", New Font("Segoe UI", 8), New SolidBrush(TextColor), New Rectangle(19, 2, Width, Height), CenterSF)
                    ...
                    If Checked Then
                        ...
                        '-- Text
                        .DrawString("ü", New Font("Segoe UI", 14), New SolidBrush(TextColor), New Rectangle(8, 7, Width, Height), NearSF)
                    End If
...
#Region " Colors"
    ...
    Private _BaseColor As Color = Color.FromArgb(45, 45, 45)
...
#Region " Colors"
    ...
    Private _BorderColor As Color = Color.FromArgb(211, 211, 211)
    Private _TextColor As Color = Color.FromArgb(211, 211, 211)
...
#Region " Colors"
    ...
    Private BGColor As Color = Color.FromArgb(40, 40, 40)
    Private _BaseColor As Color = Color.FromArgb(30, 30, 30)
    Private _ActiveColor As Color = Color.Firebrick
...
#End Region
    ...
    Sub New()
        SetStyle(ControlStyles.AllPaintingInWmPaint Or ControlStyles.UserPaint Or _
                 ControlStyles.ResizeRedraw Or ControlStyles.OptimizedDoubleBuffer, True)
        DoubleBuffered = True
        BackColor = Color.FromArgb(50, 55, 55)
...
#Region " Colors"
    ...
    Private SuccessColor As Color = Color.FromArgb(30, 30, 30)
    Private SuccessText As Color = Color.FromArgb(97, 185, 186)
    Private ErrorColor As Color = Color.FromArgb(30, 30, 30)
    Private ErrorText As Color = Color.FromArgb(254, 142, 122)
    Private InfoColor As Color = Color.FromArgb(30, 30, 30)
    Private InfoText As Color = Color.FromArgb(211, 211, 211)
...
#Region " Colors"
    ...
    Private _BaseColor As Color = Color.FromArgb(30, 30, 30)
    Private _ProgressColor As Color = Color.Firebrick
    Private _DarkerProgress As Color = Color.Firebrick
...
#End Region
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        Dim Base As New Rectangle(0, 20, W, H)
        Dim GP, GP2, GP3 As New GraphicsPath
        ...
        With G
            ...
            Select Case Value
                Case 0
                    ...
                    .FillRectangle(New SolidBrush(_BaseColor), Base)
                    '--Progress
                    .FillRectangle(New SolidBrush(_ProgressColor), New Rectangle(0, 20, iValue - 1, H - 1))
                Case 100
                    '-- Base
                    .FillRectangle(New SolidBrush(_BaseColor), Base)
                    '--Progress
                ...
                Case Else
                    ...
                    '--Progress
                    GP.AddRectangle(New Rectangle(0, 0, iValue - 1, H - 1))
                    .FillPath(New SolidBrush(Color.DarkRed), GP)

                    '-- Hatch Brush
                    Dim HB As New HatchBrush(HatchStyle.Plaid, _DarkerProgress, _ProgressColor)
                    .FillRectangle(HB, New Rectangle(0, 20, iValue - 1, H - 1))

                    '-- Balloon
                    Dim Balloon As New Rectangle(iValue - 18, 0, 34, 25)
                    GP2 = Helpers.RoundRec(Balloon, 4)
                    .FillPath(New SolidBrush(_BaseColor), GP2)

                    '-- Arrow
                    GP3 = Helpers.DrawArrow(iValue - 9, 25, True)
...
Class FlatProgressBarBlue : Inherits Control
...
#Region " Colors"
    ...
    Private _BaseColor As Color = Color.FromArgb(30, 30, 30)
    Private _ProgressColor As Color = Color.LightSeaGreen
    Private _DarkerProgress As Color = Color.LightSeaGreen
        ...
        With G
            ...
            Select Case Value
                ...
                Case Else
                    ...
                    '--Progress
                    GP.AddRectangle(New Rectangle(0, 0, iValue - 1, H - 1))
                    .FillPath(New SolidBrush(Color.LightSkyBlue), GP)
...
#Region " Colors"
    ...
    Private _HoverColor As Color = Color.FromArgb(60, 60, 60)
...
#Region " Colors"
    ...
    Private _BaseColor As Color = Color.DodgerBlue
    Private _TextColor As Color = Color.FromArgb(211, 211, 211)
...
#Region " Colors"
    ...
    Private _BaseColor As Color = Color.FromArgb(30, 30, 30)
    Private _ButtonColor As Color = Color.FromArgb(90, 90, 90)
...
#End Region
    ...
    Sub New()
        ...
        DoubleBuffered = True
        Font = New Font("Segoe UI", 10)
        BackColor = Color.FromArgb(90, 211, 90)
...
#Region " Poperties"
    ...
    Sub Drawitem(ByVal sender As Object, ByVal e As DrawItemEventArgs) Handles ListBx.DrawItem
        ...
        If InStr(e.State.ToString, "Selected,") > 0 Then '-- if selected
            '-- Base
            e.Graphics.FillRectangle(New SolidBrush(Color.FromArgb(50, 50, 50)), New Rectangle(e.Bounds.X, e.Bounds.Y, e.Bounds.Width, e.Bounds.Height))

            '-- Text
            e.Graphics.DrawString(" " & ListBx.Items(e.Index).ToString(), New Font("Segoe UI", 8), Brushes.White, e.Bounds.X, e.Bounds.Y + 2)
        Else
            '-- Base
            e.Graphics.FillRectangle(New SolidBrush(Color.FromArgb(30, 30, 30)), New Rectangle(e.Bounds.X, e.Bounds.Y, e.Bounds.Width, e.Bounds.Height))

            '-- Text 
            e.Graphics.DrawString(" " & ListBx.Items(e.Index).ToString(), New Font("Segoe UI", 8), Brushes.FloralWhite, e.Bounds.X, e.Bounds.Y + 2)
        End If
...
#Region " Colors"
    ...
    Private BaseColor As Color = Color.FromArgb(30, 30, 30)
    Private _SelectedColor As Color = Color.FromArgb(50, 50, 50)
...
#Region " Colors"
    ...
    Private BaseColor As Color = Color.FromArgb(30, 30, 30)
    Private _TrackColor As Color = Color.LightSkyBlue
    Private SliderColor As Color = Color.FromArgb(30, 30, 30)
    Private _HatchColor As Color = Color.LightSkyBlue
...
#Region " Colors"
    ...
    Private _BaseColor As Color = Color.FromArgb(30, 30, 30)
    Private _TextColor As Color = Color.FromArgb(211, 211, 211)
    Private _RectColor As Color = Color.FromArgb(211, 211, 211)
